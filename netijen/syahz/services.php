...
$resultkategori = mysqli_query($koneksi,"SELECT* FROM tbl_kategori");
...
<body>
      ...
      <div class="wrapper">
            ...
            <div class="header">
                  <h1>We are here for managing fund data.</h1>
            </div>
            ...
            <nav class="nav">
                  ...
                  <ul id="menu">
                        ...
                        <li><a href="C:/xampp/htdocs/Complete-Single-Page-Corporate-Website/services.php">Services</a></li>
                        ...
                        <div class="row members">
                              ...
                              <?php while($row=mysqli_fetch_assoc($resultfilm)): ?>
                                    ...
                                    <div class="team-title">
                                          ...
                                          <span><a href="<?php echo $row["film_link"]; ?>"><?php echo $row["film_nama"]; ?></a></span>
                                          <?php endwhile; ?>
                                    </div>
